<%@ Page Language="VB" AutoEventWireup="false" CodeFile="bookres.aspx.vb" Inherits="bookres" %>
...
<head runat="server">
  <!-- Required meta tags-->
    ...
    <meta name="description" content="BIFPCL Resource Booking" />
    ...
    <!-- Title Page-->
    <title>BIFPCL Resource Booking</title>
            ...
            <section class="statistic statistic2">
                <div class="container">
                    <div class="row">
                         ...
                         <div style="-webkit-box-shadow: 18px -18px 5px 0px rgba(0,0,0,0.75);-moz-box-shadow: 18px -18px 5px 0px rgba(0,0,0,0.75);box-shadow: 18px -18px 5px 0px rgba(0,0,0,0.75);">
                                <a href="https://forms.gle/pZrGjWK6vBR5Eazg9" target="_blank" style="color:dodgerblue;">    
                                    <i class="zmdi zmdi-plus"></i>Click Here to Book Meeting Room
                                       </a>
                             </div>
                        ...
                        <div class="col  col-12">
                           ...
                           <button type="button" class="btn btn-outline-success">
                                            <i class="fa fa-magic"></i>&nbsp; Booking Calendar</button>
                    <p>Click on Agenda/Month to see the daywise booking list. <br /> Click on the meeting name to see the details and duration.</p>
               
               <div class="responsiveCal">
                 <iframe src="https://calendar.google.com/calendar/b/1/embed?height=600&amp;wkst=1&amp;bgcolor=%234285F4&amp;ctz=Asia%2FDhaka&amp;src=YmlmcGNsLmNvbV9saXZxcG1zczVlNTFnaDZxcGpjZG1zYnQ5b0Bncm91cC5jYWxlbmRhci5nb29nbGUuY29t&amp;color=%23616161&amp;mode=AGENDA&amp;showTz=0&amp;hl=en_GB" style="border-width:0" width="800" height="600" frameborder="0" scrolling="no"></iframe>
               </div>
                            </div>
                    </div>
                </div>
